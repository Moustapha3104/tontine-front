        ...
        <div className="register-page-wrapper">
            ...
            <div className="register-card">
                <div className="l-head">
                    ...
                    <h1 className="l-title">{t('register_title')}</h1>
                    <p className="l-sub">{t('register_subtitle')}</p>
                </div>
                ...
                <div className="card" style={{ padding: '32px 24px' }}>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="ff">
                            <label className="fl2" htmlFor="register-name">{t('register_name_label')}</label>
                            <input
                                id="register-name"
                                type="text"
                                value={name}
                                ...
                                className="fi3"
                                aria-label={t('register_name_label')}
                            />
                        </div>

                        <div className="ff" style={{ marginTop: 20 }}>
                            <label className="fl2" htmlFor="register-email">{t('modal_email_label_short')}</label>
                            <input
                                id="register-email"
                                type="email"
                                value={email}
                                ...
                                className="fi3"
                                aria-label={t('modal_email_label_short')}
                            />
                        </div>

                        <div className="ff" style={{ marginTop: 20 }}>
                            <label className="fl2" htmlFor="register-password">{t('login_pass_label')}</label>
                            <input
                    ...
                    <div style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: 'var(--grey)' }}>
                        {t('register_already_member')}{' '}
                        <span onClick={onLogin} style={{ color: 'var(--white)', fontWeight: 700, cursor: 'pointer', textDecoration: 'underline' }}>
                            {t('login_btn')}
                        </span>
                    </div>
                </div>
